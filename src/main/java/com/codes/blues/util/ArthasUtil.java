...
/**
 * @author ：linzg_64
 * @date ：Created in 2020/3/30 16:00
 * @description：学习调试arthas功能的样例
 */
@Slf4j
public class ArthasUtil {
    ...
    public static void addHashSetThread() {
        System.out.println("不断的向 hashSet 集合增加数据");
        // 初始化常量
        new Thread(() -> {
            int count = 0;
            while (true) {
